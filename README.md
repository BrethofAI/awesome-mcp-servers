...
### Curated Model Context Protocol servers for Claude Desktop, Claude Code, Claude Agent SDK, and beyond
...
This list will catalog MCP servers — the plugins that let AI agents read files, call APIs, query databases, and control browsers. Curated, categorized, and tested against the current MCP spec. The MCP ecosystem is exploding in 2026; this is the canonical index.
